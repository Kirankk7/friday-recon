...
_CWE = [
    ...
    ("sensitive-file", ("CWE-538", "Insertion of Sensitive Information into Externally-Accessible File")),
...
_CVSS = [
    ...
    ("secret",        ("CVSS:3.1/AV:N/AC:L/PR:N/UI:N/S:U/C:H/I:N/A:N", 7.5, "High")),
    ("sensitive-file",("CVSS:3.1/AV:N/AC:L/PR:N/UI:N/S:U/C:H/I:N/A:N", 7.5, "High")),
...
_IMPACT = {
    ...
    "secret": "A hard-coded credential/API key is exposed in client-side code — anyone can extract and abuse it against the associated service.",
    "sensitive-file": "An internal file (source repo, environment/config, or metadata) is publicly served — source-code disclosure, secrets, or infrastructure detail leak.",
...
_REMEDIATION = {
    ...
    "secret": "Revoke and rotate the exposed key immediately; move secrets server-side / to a vault; never ship credentials in client-side code.",
    "sensitive-file": "Block public access to VCS/config/metadata files at the web server; remove them from the web root; rotate any leaked secrets.",
